...
<head>
  ...
  <!-- Theme style -->
  <!-- DataTables -->
  <link rel="stylesheet" href="backendassets/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="backendassets/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
  <!-- Theme style -->
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><img width="50px" src="./upload/<?php echo $pro['img'] ?>" alt=""></td>
                    <td ><a style="color:white;" href="delete.php?proid=<?=$pro['id'];?>"><button type="button" class="btn btn-block btn-danger">delete</a></button></td>
                    <td> <a href="uptade.php?proid=<?=$pro['id'];?>" ><button type="button"  class="btn btn-block btn-info">modify</button></a></td>
                  </tr>
                  <?php endforeach; ?>
                  </tbody>
                  <tfoot>
...
<!-- DataTables -->
<script src="backendassets/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="backendassets/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js"></script>
<script src="backendassets/plugins/datatables-responsive/js/dataTables.responsive.min.js"></script>
<script src="backendassets/plugins/datatables-responsive/js/responsive.bootstrap4.min.js"></script>
<!-- AdminLTE App -->
